...
app.post('/validar-contrasena', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en validar contraseña' });
    }
});
...
app.post('/fotos-perfil', (req, res) => {
    try{  
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en fotos perfil' });
    }
});
...
app.post('/obtener_usuarios', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en obtener usuarios' });
    }
});
...
app.put('/actualizar_datos', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en actualizar datos' });
    }
  });
...
app.post('/crear_foto_albumes', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en crear fotos albumes' });
    }
});
...
app.put('/modificar_album', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en modificar album' });
    }
});
...
app.delete('/eliminar_album', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en eliminar album' });
    }
});
...
app.post('/obtener_albumes', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en obtener album' });
    }
});
...
app.post('/obtener_fotos_perfil', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en obtener fotos perfil' });
    }
});
...
app.post('/obtener_fotos_album', (req, res) => {
    try{
        ...
        console.error('Error:', error);
        res.status(500).json({ mensaje: 'Error interno del servidor en obtener fotos album' });
    }
});
